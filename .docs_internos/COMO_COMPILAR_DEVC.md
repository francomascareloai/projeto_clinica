# 🚀 COMPILAR NO DEV-C++ - PASSO A PASSO
...
3. Escolha onde salvar:
   - Navegue ate: `C:\Users\Admin\Documents\Uniftec\Algoritmos e Programacao\projeto_clinica`
   - Salve
...
## 📋 PASSO 4: Configurar Include

1. Clique em: **Tools > Compiler Options**
...
Pressione **F11** ou clique em **Execute > Compile & Run**

**PRONTO! Deve abrir o programa funcionando!**
...
Se nao quiser criar projeto novo:

1. Abra o Dev-C++
2. Arraste os 3 arquivos (.c e .cpp) para dentro do Dev-C++
3. Compile com F9
